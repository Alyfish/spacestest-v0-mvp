...
class _MarkerInputDialogState extends State<MarkerInputDialog> {
  ...
  Widget _buildQuickChip(String label, String fillText) {
    return GestureDetector(
      onTap: () {
        _textController.text = fillText;
        _textController.selection = TextSelection.fromPosition(
          TextPosition(offset: fillText.length),
        );
      },
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Smart quick-action chips (only when adding new marker)
              if (!widget.isEditing) ...[
                ...
                Wrap(
                  ...
                  runSpacing: 8,
                  children: [
                    _buildQuickChip('Replace item', 'Replace this item with '),
                    _buildQuickChip('Remove item', 'Remove this item'),
                    _buildQuickChip('Change color', 'Change the color to '),
                  ],
                ),
              ],
