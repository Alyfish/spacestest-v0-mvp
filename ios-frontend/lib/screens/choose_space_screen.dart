...
class _ChooseSpaceContentState extends State<ChooseSpaceContent>
  ...
  final List<Map<String, String>> _spaceTypes = [
    ...
    },
    {
      ...
      'description': 'Short description..',
      'image':
          'assets/images_for_choose_spaces_new/charles-loyer-QN6fCROYdWM-unsplash.webp',
    },
    {
      'id': 'other',
      'title': 'Custom Space',
      'description': 'Short description..',
      'image':
          'assets/images_for_choose_spaces_new/Lets-Talk-About-The-Great-2018-Housing-Crash.webp',
    },
  ];
  ...
  Future<void> _onContinue() async {
    if (_selectedSpaceId == null || _isSaving) return;
    ...
    final imageReady = await projectProvider.ensureProjectImageUploaded(
      context,
    );
    if (!imageReady) {
      if (mounted) {
    ...
    if (!mounted) return;
    final success = await projectProvider.saveSpaceType(
      context,
      _selectedSpaceId!,
    );
            ...
            child: SizedBox(
              ...
              child: AnimatedContainer(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: _selectedSpaceId != null && !_isSaving
                      ? _onContinue
                      : null,
                  child: _isSaving
                      ? const SizedBox(
